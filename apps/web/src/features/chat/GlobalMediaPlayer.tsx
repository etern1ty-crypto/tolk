...
export function GlobalMediaPlayer() {
  ...
  const skipForward = () => {
    if (mediaRef.current) mediaRef.current.currentTime = Math.min(mediaRef.current.duration, mediaRef.current.currentTime + 10);
  };
      ...
      {activeMediaId && (
        ...
        >
          <div className={styles.controls}>
            <button type="button" className={styles.skipBtn} onClick={skipBack}>
            ...
            <button type="button" className={styles.skipBtn} onClick={skipForward}>
