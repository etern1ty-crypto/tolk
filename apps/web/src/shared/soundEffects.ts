class SoundEffects {
  ...
  playPixelPush() {
    try {
      ...
      gain1.gain.linearRampToValueAtTime(0.05, now + 0.008); // 8ms soft attack
      ...
      gain2.gain.linearRampToValueAtTime(0.05, now + 0.058); // 8ms soft attack
  ...
  playSent() {
    try {
      ...
      gain.gain.linearRampToValueAtTime(0.035, now + 0.01); // 10ms fade-in
  ...
  playReceivedSoft() {
    try {
      ...
      gain.gain.setValueAtTime(0.0, now);
      gain.gain.linearRampToValueAtTime(0.035, now + 0.008); // 8ms fade-in
